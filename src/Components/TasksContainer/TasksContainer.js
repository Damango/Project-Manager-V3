	...
	if (props.taskType === "to-do-list") {
		...
		return (
			<div className="tasks-container">
				...
				<div className="task-categories-wrapper">
							...
							{props.taskData.tasks
								...
								.map((task, index) => (
									<Task
										...
										index={index}
										taskCardMenu={props.taskCardMenu}
										setTaskCardMenu={props.setTaskCardMenu}
									/>
								))}
						</div>
					</div>
					...
					<div className="stuck-tasks-container">
						...
						<div className="tasks-wrapper">
							{props.taskData.tasks
								.filter((task) => task.category === "stuck")
								.map((task, index) => (
									<Task
										deleteTask={props.deleteTask}
										data={task}
